...
$("#chatIcon").on("click", function (event) {
  ...
  if (request_step == 0) {
    ...
    var divtest = ` <p class="bot_chat"><img class="responsive-img" src="//d2qetrl79qxrcm.cloudfront.net/images/vgnchatbot/robot-icon-circle2.png" width="30" style="margin-top: -1px;"> Hi, I'm your VGN Assistant. May I know your name please?</p>`;
    ...
    if (usr_typed_txt != '') {
     ...
     $(".conversation").animate({ scrollTop: $('.conversation').prop("scrollHeight") }, 2000,'swing');
      ...
      if(aa == '1'){
          ...
          var divtest = ` <p class="bot_chat"><img class="responsive-img" src="//d2qetrl79qxrcm.cloudfront.net/images/vgnchatbot/robot-icon-circle2.png" width="30" style="margin-top: -1px;"> `+data+`</p>`;
          $(".conversation").append(divtest);
          $(".typeloader").remove();
      	  ...
      	  var divtest = ` <p class="bot_chat"><img class="responsive-img" src="//d2qetrl79qxrcm.cloudfront.net/images/vgnchatbot/robot-icon-circle2.png" width="30" style="margin-top: -1px;"> Please enter a valid text.</p>`;
          $(".conversation").append(divtest);
          $(".typeloader").remove();
      	}
      });
	 ...
	 bb += 1;
      if(bb == '1'){
         ...
         $(".typeloader").remove();
          ...
          var divtest = ` <p class="bot_chat"><img class="responsive-img" src="//d2qetrl79qxrcm.cloudfront.net/images/vgnchatbot/robot-icon-circle2.png" width="30" style="margin-top: -1px;"> `+cust_name_chat+`, are you interested in buying Apartments or Plots?</p>`;
          $(".conversation").append(divtest);
...
$(".conversation").animate({ scrollTop: $('.conversation').prop("scrollHeight") }, 2000,'swing');
    ...
    cc += 1;
      if(cc == '1'){
        ...
        var divtest = ` <p class="bot_chat"><img class="responsive-img" src="//d2qetrl79qxrcm.cloudfront.net/images/vgnchatbot/robot-icon-circle2.png" width="30" style="margin-top: -1px;"> `+cust_name_chat+`, May I know your budget range please?</p>`;
        $(".conversation").append(divtest);
...
$.post('/api/vgncustomchatreq/gettypelocations',{projecttype_intrested: projtype_chat,session:session}, function(data){
	if (data != 0) {
      ...
      if(dd == '1'){
        ...
        var divtest = ` <p class="bot_chat"><img class="responsive-img" src="//d2qetrl79qxrcm.cloudfront.net/images/vgnchatbot/robot-icon-circle2.png" width="30" style="margin-top: -1px;"> `+cust_name_chat+`,  In which location would you like to buy</p>`;
        $(".conversation").append(divtest);
		...
		var divtest = ` <p class="bot_chat"><img class="responsive-img" src="//d2qetrl79qxrcm.cloudfront.net/images/vgnchatbot/robot-icon-circle2.png" width="30" style="margin-top: -1px;"> Please enter a valid option.</p>`;
          $(".conversation").append(divtest);
          $(".typeloader").remove();
	}
});
	...
	if (data != 0) {
      ...
      if(ee == '1'){
        ...
        $(".conversation").append(`<p class="usr_response"><span class="badge_css red" >` + usr_typed_txt + `</span></p>`);
          ...
          var divtest = ` <p class="bot_chat"><img class="responsive-img" src="//d2qetrl79qxrcm.cloudfront.net/images/vgnchatbot/robot-icon-circle2.png" width="30" style="margin-top: -1px;"> `+cust_name_chat+`, Please select the project you are interested in</p>`;
          $(".conversation").append(divtest);
		...
		var divtest = ` <p class="bot_chat"><img class="responsive-img" src="//d2qetrl79qxrcm.cloudfront.net/images/vgnchatbot/robot-icon-circle2.png" width="30" style="margin-top: -1px;"> Please enter a valid project name.</p>`;
          $(".conversation").append(divtest);
          $(".typeloader").remove();
	}
	...
	if (data != 0) {
      ...
      if(ff == '1'){
        ...
        $(".conversation").append(`<p class="usr_response"><span class="badge_css red" data-badge-caption="` + project_intrested + `"> VGN ` + project_intrested + `</span></p>`);
        	...
        	var divtest1 = ` <p class="bot_chat"><img class="responsive-img" src="//d2qetrl79qxrcm.cloudfront.net/images/vgnchatbot/robot-icon-circle2.png" width="30" style="margin-top: -1px;"> `+cust_name_chat+`, Kindly share your email address to send you the relevant project details.</p>`;
      ...
      if(gg == '1'){
        ...
        $(".conversation").append(`<p class="usr_response"><span class="badge_css red" data-badge-caption="` + usr_typed_txt + `">` + usr_typed_txt + `</span></p>`);
          ...
          if (data == 0) {
            ...
            var divtest1 = ` <p class="bot_chat"><img class="responsive-img" src="//d2qetrl79qxrcm.cloudfront.net/images/vgnchatbot/robot-icon-circle2.png" width="30" style="margin-top: -1px;"> Thank You `+cust_name_chat+`. Our sales representative will get in touch with you shortly.</p>`;
            $(".conversation").append(divtest1);
