 ...
 * GPG key class
 */
require_once 'assets/libs/newpgp/Crypt/GPG/Key.php';

/**
 * GPG sub-key class
 */
require_once 'assets/libs/newpgp/Crypt/GPG/SubKey.php';

/**
 * GPG user id class
 */
require_once 'assets/libs/newpgp/Crypt/GPG/UserId.php';

/**
 * GPG process and I/O engine class
 */
require_once 'assets/libs/newpgp/Crypt/GPG/Engine.php';
