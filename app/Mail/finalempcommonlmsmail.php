...
class finalempcommonlmsmail extends Mailable
{
    ...
    public function build()
    {
        // dd($this->applicationlist);
         ...
         if ($this->applicationlist['member'] == 'HOD') {
         ...
         if ($this->applicationlist['member'] == 'Admin') {
            $subject = $this->applicationlist['leave_processed']['type']." Application on ";
            ...
            $frommail = $this->applicationlist['employee_off_mail'];
            $ccmail = $this->applicationlist['employee_off_mail'];
            $subject = 'HOD: '.$this->applicationlist['leave_processed']['hod_status'].' - '.$subject.$sub_leave_date;
         }

         if ($this->applicationlist['member'] == 'finaladmin') {
            $subject = $this->applicationlist['leave_processed']['type']." Application on ";
            ...
            $frommail = $this->applicationlist['employee_off_mail'];
            $ccmail = $this->applicationlist['employee_off_mail'];
            $subject = 'HOD: '.$this->applicationlist['leave_processed']['admin_status'].' - '.$subject.$sub_leave_date;
         }
         ...
         if ($this->applicationlist['leave_processed']['saved_file_path'] != null) {
             return $this->view('vendor.finalmailemployee')
