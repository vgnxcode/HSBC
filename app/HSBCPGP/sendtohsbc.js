...
<CstmrCdtTrfInitn>
<GrpHdr>
<MsgId>`+data[v].Message_Id+`</MsgId>
<CreDtTm>`+data[v].current_date+`T`+data[v].current_time+`</CreDtTm>
<NbOfTxs>1</NbOfTxs>
<CtrlSum>`+data[v].Amount+`</CtrlSum>
<InitgPty>
<Id>
<OrgId>
<Othr>
...
<PmtInf>
<PmtInfId>`+data[v].payrefid+`</PmtInfId>
<PmtMtd>TRF</PmtMtd>
<PmtTpInf>
<SvcLvl>
<Cd>`+data[v].hsbc_trans_type+`</Cd>
</SvcLvl>
</PmtTpInf>
<ReqdExctnDt>`+data[v].current_date+`</ReqdExctnDt>
<Dbtr>
<Nm>`+data[v].Company_Name+`</Nm>
<PstlAdr>
<StrtNm>`+data[v].Street_Name+`</StrtNm>
<BldgNb>`+data[v].Flat_No+`</BldgNb>
<PstCd>`+data[v].Pin_code+`</PstCd>
<TwnNm>`+data[v].City+`</TwnNm>
<CtrySubDvsn>`+data[v].State+`</CtrySubDvsn>
<Ctry>IN</Ctry>
</PstlAdr>
</Dbtr>
<DbtrAcct>
<Id>
<Othr>
<Id>`+data[v].Company_Account_No+`</Id> 
</Othr>
</Id>
</DbtrAcct>
<DbtrAgt>
...
<CdtTrfTxInf>
<PmtId>
<InstrId>`+data[v].instrid+`</InstrId> 
<EndToEndId>`+data[v].instrid+`</EndToEndId> 
</PmtId>
<Amt>
<InstdAmt Ccy="INR">`+data[v].Amount+`</InstdAmt> 
</Amt>
<CdtrAgt>
<FinInstnId>
<ClrSysMmbId>
<MmbId>`+data[v].IFSC_Code+`</MmbId> 
</ClrSysMmbId>
<Nm>`+data[v].Beneficiary_Bank_Name+`</Nm>
<PstlAdr>
<Ctry>IN</Ctry> 
</PstlAdr>
</FinInstnId>
...
<Cdtr>
<Nm>`+encodeURIComponent(data[v].Beneficiary_Name)+`</Nm>
</Cdtr>
<CdtrAcct>
<Id>
<Othr>
<Id>`+data[v].Beneficiary_Account_No+`</Id> 
</Othr>
</Id>
</CdtrAcct>
<RmtInf>
<Ustrd>`+data[v].Id_Ref+`</Ustrd>
</RmtInf>
</CdtTrfTxInf>
</PmtInf>
</CstmrCdtTrfInitn>
...
axios
  .post('https://www.vgn.in/api/posttohsbc_instant_receipt', {
