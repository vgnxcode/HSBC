...
{
    public function checkfornri($id)
    {
         $checkfornriprojects = array('109'=>'0000001356',
                    '14'=>'0000001355',
                    '5'=>'0000001354',
                    '13'=>'0000001353',
                    '2' => '0000001352',
                ...
                if (array_key_exists($id,$checkfornriprojects) === false) {
                    return 0;
                }else{
                    return $checkfornriprojects[$id];
                }
    }
    public function show($name = null) {
		...
		$id = $list['id'];
            ...
            if(count($getcoordinates) != 0){
                ...
                return view('NRIProject.individualprojectpage')->with(['list' => $list, 'sqftrange' => $sqftrange, 'floorplanfiles' => $floorplanfiles, 'consplanfiles' => $consplanfiles, 'ebrochplanfiles' => $ebrochplanfiles,'latitude'=>$latitude] );
    ...
    return redirect()->route('potpproject', ['name' => $name]);
        ...
        if($name == null) {
            ...
            $sqftrange =  sqft_range::where('P_id','=',$id)->get();
                ...
                return view('Project.individualprojectpage')->with(['list' => $list, 'sqftrange' => $sqftrange, 'floorplanfiles' => $floorplanfiles, 'consplanfiles' => $consplanfiles, 'ebrochplanfiles' => $ebrochplanfiles] );
...
if ($sessiondata['Project_name'] != $pname) {
    ...
    return redirect()->route('project', ['name' => $name]);
                ...
                return view('Project.otpverify')->with(['list' => $list, 'sqftrange' => $sqftrange, 'floorplanfiles' => $floorplanfiles, 'consplanfiles' => $consplanfiles, 'ebrochplanfiles' => $ebrochplanfiles] );
         ...
         if($name == null) {
            ...
            $id = $list['id'];
             ...
             $floordirectory = public_path()."/images/floorplan/".$id;
                ...
                return view('Project.floorplan')->with(['list' => $list, 'sqftrange' => $sqftrange, 'floorplanfiles' => $floorplanfiles] );
         ...
         if($name == null) {
            ...
            $id = $list['id'];
             ...
             $consdirectory = public_path()."/images/construction/".$id;
                ...
                return view('Project.construction')->with(['list' => $list, 'sqftrange' => $sqftrange, 'consplanfiles' => $consplanfiles] );
            ...
            $id = $list['id'];
             ...
             $consdirectory = public_path()."/images/construction/".$id;
                ...
                foreach ($consplanfiles as $value) {
                    ...
                    if (!empty($value->getRelativePath())) {
                       // dd($value->getRelativePathname());
                        ...
                        $imagearray[$k]['image'] = "/images/construction/".$id."/".$value->getRelativePathname();
               ...
               // dd($imagearray);
                ...
                return view('Project.constructionnew')->with(['list' => $list, 'imagearray' => $imagearray, 'consplanfiles' => $consplanfiles,'folder'=>$folder] );
...
return $result;
    ...
    public function insertlead(Request $request,$name = null) {
        if($name == null) {
            ...
            if(!empty($projectlistnew)){
                $campaigncode = $this->checkfornri($id);
             ...
             if(!empty($data)) {
                ...
                $lead_check = lead_data::select('lead_datetime')->where('Source_type','=','NRI')->where('Project_id','=',$id)->where('Email','=',$request->Email)->orderBy('lead_datetime', 'desc')->first();
            ...
            $sqftrange =  sqft_range::where('P_id','=',$id)->get();
            //return view('Project.thanks')->with(['list' => $list, 'sqftrange' => $sqftrange] );
            return redirect()->route('nriproject_thanks', ['name' => $name]);
            }
            else{
    ...
    public function thanks(Request $request, $name = null) {
         ...
         if($name == null) {
			...
			return redirect()->route("nriproject",['name',$name]);
		}
            ...
            $sqftrange =  sqft_range::where('P_id','=',$id)->get();
            return view('NRIProject.thanks')->with(['list' => $list, 'sqftrange' => $sqftrange] );
        }
    }
...
else
{
    ...
    public function linkchangethanks(Request $request, $name, $url, $newpagename) {
