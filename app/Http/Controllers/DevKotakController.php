...
use vgn\Http\Traits\Devkotakbanktrait;

class DevKotakController extends Controller
{
	use Devkotakbanktrait;
...
public function kotakprocess(
                        ...
                        $Fiscal_Year,$companybankno)
    {
        ...
        $soapUrl = "https://apigwuat.kotak.com:8443/cms_generic_service"; // asmx URL of WSDL
        ...
        $request .= '<pay:Payment>';
            ...
            $request .= '<pay:InstrumentList>';
                $request .= '<pay:instrument>';
                    ...
                    $request .= '<pay:AccountNo>09582650000173</pay:AccountNo>';
 ...
 */
  ...
  curl_setopt($soap_curl, CURLOPT_URL, "https://apigwuat.kotak.com:8443/cms_generic_service" );
