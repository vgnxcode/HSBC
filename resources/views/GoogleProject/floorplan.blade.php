...
@section('title')
VGN {{ $list->Project_name }} Floor Plan
@endsection

@section('description')
<META NAME="Subject" CONTENT="VGN {{ $list->Project_name }} Floor Plan">
<meta name="description" content="VGN {{ $list->Project_name }} Project Floor Plan">
...
$imgid = $list->id;
 ...
 <section style="position:relative;text-align:center;">
       <picture>
          <source media="(max-width: 768px)" type="image/jpeg" srcset="/images/banner/mobile/<?php echo $imgid; ?>.jpg">
          <source media="(min-width: 768px)" type="image/jpeg" srcset="/images/banner/<?php echo $imgid; ?>.jpg">

          <img src="/images/banner/<?php echo $imgid; ?>.jpg" alt="<?php echo $projectname_str; ?>" title="<?php echo $projectname_str; ?>">
        </picture>
    </section>
