...
<div class="container" style="padding: 24px;">
        <div class="row">
          ...
          <div class="col-md-4 hide-on-small-only" style="top: 0;right: -45px;">
            ...
            <form class="col s12" action="{{ url('/google/otpverify') }}/{{$type}}/{{$location}}/{{$projectname_str}}" method="post" style="color:#000;">
                      {{ csrf_field() }}
				...
				@endif
                  ...
                  <div class="input-field col s10 m12">
                    ...
                    <button type="button" onclick="window.location.href='{{ url('/googlead-display/otplogout') }}/{{$projectname_str}}'" class="waves-effect waves-light btn red white-text">Cancel</button>
                    </div>
                    </div>
        ...
        <div class="container">
            ...
            @if(session()->has('otpdata'))
                 <div class="row">
                    ...
                    <form class="col s12" action="{{ url('/google/otpverify') }}/{{$type}}/{{$location}}/{{$projectname_str}}" method="post">
                      {{ csrf_field() }}
                       @if(session()->has('error_msg'))
				...
				@endif
                    ...
                    <button type="button" onclick="window.location.href='{{ url('/google/otplogout') }}/{{$projectname_str}}'" class="waves-effect waves-light btn red white-text col s4 m6">Cancel</button>
                    </div>
                    </div>
