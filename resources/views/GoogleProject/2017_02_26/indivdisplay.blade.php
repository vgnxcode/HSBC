...
<div class="container" style="padding: 24px;">
        <div class="row">
          ...
          <div class="col-md-4 hide-on-small-only" style="top: 0;right: -45px;">
            ...
            <form class="col s12" action="{{ url('/google/') }}/{{$type}}/{{$location}}/{{$projectname_str}}" method="post" style="color:#000;">
                      {{ csrf_field() }}
            ...
            <div class="card s12">
               <div class="card-content" >
                 ...
                 <div class="row">
                    ...
                    <form class="col s12" action="{{ url('/google/') }}/{{$type}}/{{$location}}/{{$projectname_str}}" method="post">
                      {{ csrf_field() }}
                       @if(session()->has('error_msg'))
