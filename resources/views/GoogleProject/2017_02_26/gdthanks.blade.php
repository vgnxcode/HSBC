...
@if(file_exists( public_path() . '/images/banner/' . $list->id . '.jpg'))
 ...
 <!-- Banner start -->
    ...
    <div class="secinner padd-tb-120" style="background:rgba(255,255,255, .2);height: 100%; width: 100%;">
  @else
...
<div class="row bread">
  ...
  <li><a href="{{ url('/googlead-display/project/') }}/{{$projectname_str}}">VGN {{$list->Project_name}}</a></li>
  <li>Thank You</li>
</ul>
</div>
        </div>
...
@endif
  ...
  <h2 class="newtitle center-align">Thanks for your Enquiry</h2> <h2 class="newtitle center-align"><br><a href="{{ url('/googlead-display/project/')}}/{{$projectname_str}}" class="btn newwhitewave waves-effect waves-light btn-medium regular-text"><i class="mdi-content-reply left"></i> Go Back</a></h2>
</section>
