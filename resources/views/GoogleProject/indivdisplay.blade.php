...
@if(in_array($id,config('ProjectSliderList')))
<div class="owl-carousel owl-theme">
  @foreach($bannerfiles as $k=>$cons)
    <div class="item" data-merge="6">
      <picture>
        ...
        <img src="{{ config('app.AWS_URL')}}/{{$cons}}" alt="<?php echo $projectname_str; ?>" title="<?php echo $projectname_str; ?>">
      </picture>
    </div>
  @endforeach
</div>
...
@endif
               ...
               <div class="col-md-3 hide-on-med-and-down" style="position:absolute; top:4%; right:4%;z-index:1">
                <div class="card s12">
                   <div class="card-content" style="text-align: center;" >
                 <span class="card-title" style="color: #EF533B;font-size: 18px;
        font-weight: 400;">For more information Kindly Fill in</span>
            <form class="col s12" action="{{ $current_route}}" method="post" style="color:#000;">
                      {{ csrf_field() }}
...
<section class="root-sec enquireform " id="mobform">
    ...
    font-weight: 400;">For more information Kindly Fill in</span>
                 <div class="row">
                    <form class="col s12" action="{{ $current_route }}" method="post">
                      {{ csrf_field() }}
                       @if(session()->has('error_msg'))
