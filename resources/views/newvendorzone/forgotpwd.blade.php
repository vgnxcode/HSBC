...
<div class="login-box box box-danger">
  ...
  <div class="login-box-body box-body">
    ...
    <form id="myForm" method="POST" action="{{ url('/vendorzone/forgotpassword')}}">
    {{ csrf_field() }}
      <div class="form-group has-feedback">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
        <input type="text" class="form-control" name="forgotusername" id="cid"  value="{{ old('username')}}" placeholder="Vendor-Id/EmailId/Mobile No.">
    ...
    <a href="{{ url('/vendorzone/vendorlogin') }}"><i class="fa fa-backward margin-r-5"></i>Vendor Login</a><br>
