...
@section('title')
VGN Projects Estates Pvt Ltd |Customer Zone| Reset Password Page
@endsection
...
<div class="login-box box box-danger">
  ...
  <div class="login-box-body box-body">
    ...
    <form id="myForm" method="POST" action="{{ url('/vendorzone/resetlink')}}">
    {{ csrf_field() }}
    ...
    <div class="social-auth-links text-center">
      <p>To know your vendor-Id or registered email/phone. Contact our VGN at <a href="tel:04443439900">044 43439900</a></p>
      
    </div>
    <!-- /.social-auth-links -->

    <a href="{{ url('/vendorzone/vendorlogin') }}"><i class="fa fa-user margin-r-5"></i> Vendor Login</a><br>
