...
@section('title')
VGN Projects Estates Pvt Ltd |Vendor Zone| Payment History Page
@endsection
    ...
    <div class="col-md-12">
      ...
      <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-rupee margin-r-5"></i> Payment History </h3><span class="pull-right text-red" style="font-weight:bold;" >Net Balance: {{ $vendor->net_amt }}</span>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<div class="row">
  ...
  <h4>Note:</h4>
  <ul>
    <li>Last 90 days transactions are shown here.</li>
    <li>For any further information. Please contact your concerned VGN Procurement executive.</li>
  </ul>
</div>
</div>
...
echo "<tr><td>".($i+1)."</td><td>".$pay->posteddate."</td>                                     <td>".$pay->ref_no."</td><td>".$pay->doc_no."</td><td align='right'>";
												if($pay->pay_type =="Invoice"){
																echo $Payment;
                                                }
        ...
        <tfoot>
            <tr>
                ...
                <th style="color:transparent;">Reference Number</th>
