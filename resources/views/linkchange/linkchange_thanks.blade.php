...
<?php $projectname_str = strtolower(str_replace(' ', '_', $list->Project_name)); ?>
  ...
  <h2 class="newtitle center-align">Thanks for your Enquiry</h2> <h2 class="newtitle center-align"><br><a href="{{ url('/') }}/{{$projectname_str}}/{{$newpagename}}" class="btn newwhitewave waves-effect waves-light btn-medium regular-text"><i class="mdi-content-reply left"></i> Go Back</a></h2>
</section>
@endsection
