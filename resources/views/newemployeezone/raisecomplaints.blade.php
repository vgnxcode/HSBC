...
@section('title')
VGN Projects Estates Pvt Ltd |Employee Zone| Raise Complaint Page
@endsection
    ...
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-microphone margin-r-5"></i> Raise Complaints </h3><span class="pull-right" ><a href="{{ url('/employeezone/complaints') }}" class="btn btn-danger btn-xs"><i class="fa fa-back margin-r-5"></i>Back</a></span>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
               ...
               <div class="col-sm-6 col-sm-offset-3">
                ...
                <form id="changedetailsForm" method="POST" action="{{ url('/employeezone/raisecomplaints') }}" class="form-horizontal" >
                {{ csrf_field() }}
                       ...
                       <div class="col-md-12">
											...
											<div class="form-group">
												<div class="col-sm-7"> 
													...
													<a href="{{ url('/employeezone/complaints') }}" class="btn btn-warning">Cancel</a>
												</div> 
											</div>
