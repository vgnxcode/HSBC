    ...
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-bank margin-r-5"></i> My Bank Details </h3><span class="pull-right" ><a href="{{ url('/employeezone/editempbankdetails') }}" class="btn btn-danger btn-xs"><i class="fa fa-edit margin-r-5"></i>Edit</a></span>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
