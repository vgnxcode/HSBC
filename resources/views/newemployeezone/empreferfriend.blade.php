...
@section('title')
VGN Projects Estates Pvt Ltd |Employee Zone| Employee Refer friend Page
@endsection
    ...
    <div class="col-md-12">
      ...
      <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-bullhorn margin-r-5"></i> My Employee Referrals </h3>                
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <tbody>
            ...
            @if(count($getcareer) > 0)
													<?php $count = 1; ?>
													@foreach($getcareer['VGN_CAREERS'] as $career)
                          @if(!empty($career['JOB_CODE']))
														<tr>
														<td>{{$count}}</td>
														...
														<td align='center'><a href="{{ url('/employeezone/empreferfriendapplyjob/')}}/{{$career['JOB_CODE']}}" class="btn btn-danger btn-xs marg_left"><i class="fa  fa-hand-pointer-o margin-r-5"></i> Apply</a></td>														
														</tr>
                            @endif
														<?php $count++; ?>
													@endforeach
