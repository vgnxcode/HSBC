...
@section('title')
VGN Projects Estates Pvt Ltd |Employee Zone| Reset Password Page
@endsection
...
@section('style')
@include('newemployeezone.styles.signincss')
<style>
.login-page{
        background: url("{{ config('app.AWS_URL')}}/newemployeezoneassets/img/pattern.jpg") repeat;
    }
...
<div class="login-box box box-danger">
  ...
  <div class="login-box-body box-body">
    ...
    <form id="myForm" method="POST" action="{{ url('/employeezone/resetlink')}}">
    {{ csrf_field() }}
    ...
    <div class="social-auth-links text-center">
      <p>To know your Employee-Id or official email/phone. Contact our HR Team.</p>
      
    </div>
    <!-- /.social-auth-links -->

    <a href="{{ url('/employeezone/employeelogin') }}"><i class="fa fa-user margin-r-5"></i> Employee Login</a><br>
...
@section('script')
@include('newemployeezone.js.signinjs')
<script>
  $(function () {
    $('input').iCheck({
