...
@section('title')
VGN Projects Estates Pvt Ltd |Employee Zone| View Lead Details Page
@endsection
    ...
    <div class="col-md-12">
      ...
      <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-bullhorn margin-r-5"></i> {{$title}}</h3>                
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <td>{{ $res['Project'] }}</td>
        <td>{{ $res['Sales_Exe'] }}</td>
        <td><?php echo  substr($res['Cr_Date'], 6,2).'-'.substr($res['Cr_Date'], 4,2).'-'.substr($res['Cr_Date'], 0,4); ?></td>
        <td><?php echo  substr($res['SV_Date'], 6,2).'-'.substr($res['SV_Date'], 4,2).'-'.substr($res['SV_Date'], 0,4); ?></td>
