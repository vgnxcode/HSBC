...
@section('title')
VGN Projects Estates Pvt Ltd |Employee Zone| Filtered Lead selection Page
@endsection
    ...
    <div class="col-md-12">
      ...
      <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-edit margin-r-5"></i> FILTERED LEAD SELECTION </h3>
                
                <span class="pull-right" ><a href="{{ url('/employeezone/leadselection') }}" class="btn btn-danger btn-xs"><i class="fa fa-backward margin-r-5"></i>Back</a></span>
        ...
        <tbody>
            ...
            @if(count($mainarray) > 0)
													...
													@foreach($mainarray as $value)
														...
														<tr>
				<td><a href="{{ url('/employeezone/customercreationstep1/') }}/{{$value['Lead_No']}}" class="btn btn-primary">Select</a></td>

														<td>{{$value['Plant']}}</td>
														<td>{{$value['Lead_No']}}</td>
														<td><?php echo $value['Lead_Name']; ?></td>
														<td><?php echo substr($value['Created_On'], 0,4).'-'.substr($value['Created_On'],4,2).'-'.substr($value['Created_On'], 6,2); ?></td>
														<td><?php echo $value['Sales_Exe']; ?></td>
														</tr>
