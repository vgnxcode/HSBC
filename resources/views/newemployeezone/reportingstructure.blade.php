...
@foreach($getemployeedata as $employee)
    ...
    <div class="col-md-12">
      ...
      <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-tree margin-r-5"></i> Reporting Structure </h3>
            </div>
            <!-- /.box-header -->
  ...
  <br>
    ...
    <button type="button" id="btn-report-path">Click node to draw other employee reporting path</button>
    <button type="button" id="btn-report-mypath">Reset to My Employee Node</button>
