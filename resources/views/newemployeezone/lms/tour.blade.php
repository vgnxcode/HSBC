	...
	@include('newemployeezone.contenttop')
      ...
      <section class="content-header">
        ...
        <div class="box box-primary card">
            <div class="box-header with-border">
              <h2 class="box-title">Tour Application</h2>
            ...
            {{csrf_field()}}
              <div class="box-body">
               ...
               <input type="hidden" name="leave_type" value="Tour" required>
               <input type="hidden" name="partial_days" value="full" required>

                <div class="row" id="leave_date_range_div">

                <div class="col-lg-8  col-lg-offset-2">
                <div class="form-group">
                <label>Tour Daterange:</label>
                ...
                <!-- /.input group -->
                 ...
                 <div class="form-group">
                  <label>Reason</label>
                  <textarea class="form-control" rows="3" placeholder="Tour reason ..." name="leave_reason" id="leave_reason">{{old('leave_reason')}}</textarea>
            ...
            <ol>
              <h4>Instructions:</h4>
              <li>Employees can apply for Tour if he/she is out of the station for an official business trip only.</li>
            </ol>
            </div>
          </div>
