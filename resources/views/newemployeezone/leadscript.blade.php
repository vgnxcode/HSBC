...
@section('title')
VGN Projects Estates Pvt Ltd |Employee Zone| Lead Script Page
@endsection
    ...
    <div class="col-md-12">
      ...
      <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-bullhorn margin-r-5"></i> Lead Script</h3>                
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <tr>
          <td><a href="{{url('/employeezone/leadscriptdetails/')}}/{{$type}}/{{$k}}" class="btn btn-xs btn-danger">View</a></td>
          <td>{{$count}}</td>
        <td>{{$k}}</td>
        <td>{{$res}}</td>
