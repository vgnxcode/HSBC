...
<section class="root-sec brand-bg" style="text-align:center;">
          ...
          <img src="{{ config('app.AWS_URL')}}/{{$banner}}" title="<?php echo $projectname_str; ?>">
        </picture>
          @else
...
@if($list->single_quote != null)
    <section class="root-sec " style=" padding: 10px; color:#000;">
...
@if(count($floorplanfiles) > 0)
    ...
    <!-- Zones Section end -->
    <section id="floorplan" class="scroll-section root-sec  lighten-5 ">
                            ...
                            <div class="card" style="box-shadow: none;">
                              <div class="card-image waves-effect waves-block waves-light">
                                ...
                                <div class="valign-wrapper card-img-wrap">
                                  ...
                                  <img class="activator" src="{{ config('app.AWS_URL')}}/{{$floor}}" alt="{{$name}}">
                                </div>
                              </div>
