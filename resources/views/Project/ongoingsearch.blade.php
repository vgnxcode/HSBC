...
@section('title')
Premium apartments and plots for sale in Chennai - VGN
@endsection

@section('description')
    <META NAME="Subject" CONTENT="Premium real estate developers in chennai">
<meta name="description" content="VGN – Best real estate builders and developers in Chennai. Explore the budget-friendly residential properties like flats, apartments and plots across all prime areas">
<meta name="keywords" content="2 Bhk Flat For Sale In Chennai, Flats For Sale In Chennai, Apartments For Sale In Chennai, 3 Bhk Apartment For Sale In Chennai, 2 Bhk Apartment In Chennai, Buy Apartment In Chennai, Land For Sale In Chennai, Residential Plots For Sale In Chennai, New Flats For Sale In Chennai, Buy Flats In Chennai, Gated Community Plots In Chennai, Luxury Apartments In Chennai, Flats And Apartments In Chennai, New Flats In Chennai, Properties For Sale In Chennai, Plots For Sale In Chennai">
...
<meta property='og:title' content='Premium apartments and plots for sale in Chennai - VGN Projects Estates'/>
<meta property='og:description' content='VGN Projects Estates – Best real estate builders and developers in Chennai. Explore the budget-friendly residential properties like flats, apartments and plots across all prime areas'/>
...
$("#budget").val('');
                ...
                <div class="card-image">
                  ...
                  if(val.no_details != null){
                      ...
                      content += `<a href="{{ url('/project')}}/`+projectname+`">`
                       ...
                       content += `<img class="activator img-responsive" src="{{ config('app.AWS_URL')}}/`+val.projectthumbimagelink+`" alt="`+val.Project_name+`"></a>
                    </div>`;
        ...
        $("#searchbtn").on("click", function(){
           ...
           var ptype = $("#projecttype").val();
            ...
            $.post('/Premium-Real-Estate-Developers-in-Chennai', {_token:"{{csrf_token()}}",location: location,budget:budget,ptype:ptype}, function(result){
