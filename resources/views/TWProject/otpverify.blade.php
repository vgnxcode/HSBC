...
<form class="col s12" action="{{ url('/twitter-otpverify/project/') }}/{{$projectname_str}}" method="post" style="color:#000;">
                      {{ csrf_field() }}
				...
				@endif
                  ...
                  <div class="input-field col s10 m12">
                    ...
                    <button type="button" onclick="window.location.href='{{ url('/twitter-page/otplogout') }}/{{$projectname_str}}'" class="waves-effect waves-light btn red white-text">Cancel</button>
                    </div>
                    </div>
...
<div class="row">
    <div class="center-align">
          ...
          @if(Storage::disk('s3')->exists('/images/project_logo/' . $list->id . '.jpg'))
           ...
           @else
          <img src="{{ config('app.AWS_URL')}}.'/images/project_logo/') }}/{{$list->id}}.jpg" class="img-responsive title imgtitle" style="padding-top: 15px;" alt="Project Logo">
          @endif
    ...
    font-weight: 400;">For more information Kindly Fill in</span>
            @if(session()->has('twotpdata'))
                 <div class="row">
                    ...
                    <form class="col s12" action="{{ url('/twitter-otpverify/project/') }}/{{$projectname_str}}" method="post">
                      {{ csrf_field() }}
                       @if(session()->has('error_msg'))
				...
				@endif
                    ...
                    <button type="button" onclick="window.location.href='{{ url('/twitter-page/otplogout') }}/{{$projectname_str}}'" class="waves-effect waves-light btn red white-text col s4 m6">Cancel</button>
                    </div>
                    </div>
