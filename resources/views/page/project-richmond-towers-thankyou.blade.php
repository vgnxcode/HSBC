...
<head>
  <meta charset="utf-8">
  <title>Luxury 2 & 3 BHK Homes in the Heart of Guindy - VGN</title>

  <meta name="description" content="VGN Richmond Towers in prime location of Guindy(Chennai) offers luxury apartments and flats with exclusive amenities. Enquire Now For Booking.">
  ...
  <meta property="og:title" content="Luxury 2 & 3 BHK Homes in the Heart of Guindy - VGN" />
  <meta property="og:description" content="VGN Richmond Towers in prime location of Guindy(Chennai) offers luxury apartments and flats with exclusive amenities. Enquire Now For Booking." />
  <meta property="og:url" content="https://www.vgn.in/projects/richmond-towers-guindy-chennai-thank-you" />
  <meta property="og:image" content="https://www.vgn.in/asset/img/logo.webp" />
  <meta property="og:site_name" content="VGN" />



  <link rel="canonical" href="https://www.vgn.in/projects/richmond-towers-guindy-chennai-thank-you" />
  ...
  <script type="application/ld+json">
    {
      ...
      "itemListElement": [{
        ...
        "@type": "ListItem",
        "position": 2,
        "name": "VGN Kensington Towers",
        "item": "https://www.vgn.in/projects/kensington-towers-guindy-chennai-thank-you"
      }]
    }
  </script>
...
<body>
  ...
  <header>
    ...
    <div class="header-bottom project-bottom-header">
      ...
      <div class="item">
        <img src="/asset/img/richmond-towers/banner/webdesktop.jpg" class="img-fluid d-lg-block d-md-block d-sm-none d-none" width="100%" alt="VGN Kensington Tower - Ultra Luxury Homes">
        <img src="/asset/img/richmond-towers/banner/webmobile.jpg" class="img-fluid d-lg-none d-md-none d-sm-block d-block" alt="banner" width="100%">
      </div>
      <!--  <div class="item">
      ...
      <div class="project-right-box extra-height-projects">
        <div class="project-fairmont-wrap">
          <div class="fairmont-logo d-lg-block d-md-block d-sm-none d-none">
            <img src="/asset/img/richmond-towers/logo.webp?v=4" class="img-fluid">
            <div class="projects-heading-location">
              <h2 style="font-size: 17px;">Luxury 2 & 3 BHK Homes In the Heart of Guindy</h2>
              {{-- <h3>₹1.14 Crore <span>Onwards* </span></h3> --}}
            </div>
          </div>
        </div>
        <div class="projects-heading-location price-heading d-lg-none d-md-none d-sm-block d-block">
          {{-- <h3>₹1.83 Crore <span>Onwards* </span></h3> --}}
        </div>
        <div class="project-inner-details-top">
          <div class="project-inner-top-wrap thankyou-heading">
            <h2>Thank you</h2>
            <p>Thank you for showing interest in VGN Richmond Towers. One of our sales representatives will contact you shortly</p>
          </div>
          <div class="project-inner-banner-top-buttons" style="padding-top: 18px;">
            <div class="row">

              <div class="col-md-6">
                <div class="project-inner-download">
                <a href="/asset/brochure/richmond-towers/VGN-Richmond-e-brouchure-2025.pdf" download>E-Brochure <i class="fa fa-download" aria-hidden="true"></i></a>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-6 p-0">
          <div class="footer-inner-icon">
            <a href="tel:04443439999" class="btn"><img src="/asset/img/icons/footer-phone.webp?v=4"> Call</a>
          </div>
        </div>
        <!--  <div class="col-4 p-0">
            <div class="footer-inner-icon">
        ...
        <div class="col-6 p-0">
          <div class="footer-inner-icons">
            <a href="#" id="element_id" class="btn"><img src="/asset/img/icons/top-page.webp?v=4"> Top </a>
          </div>
        </div>
      </div>
    </div>
