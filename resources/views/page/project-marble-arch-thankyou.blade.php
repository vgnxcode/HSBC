...
<head>
  <meta charset="utf-8">
  <title>2 & 3 BHK Luxury Flats In Tambaram - Marble Arch | VGN</title>

  <meta name="description" content="VGN Marble Arch Tambaram offers 2 & 3 BHK luxury apartments coupled with convenience in Tambaram, 1 km from the Tambaram Railyway Stationfor sale @1.23 Crore onwards.">
...
<meta property="og:title" content="2 & 3 BHK Luxury Flats In Tambaram - Marble Arch | VGN" />
<meta property="og:description" content="VGN Marble Arch Tambaram offers 2 & 3 BHK luxury apartments coupled with convenience in Tambaram, 1 km from the Tambaram Railyway Stationfor sale @1.23 Crore onwards." />
<meta property="og:url" content="{{ url()->full() }}/projects/marble-arch-tambaram-chennai-thank-you" />
<meta property="og:image" content="{{ url()->full() }}/asset/img/logo.webp" />
<meta property="og:site_name" content="VGN" />


 <link rel="canonical" href="{{ url()->full() }}/projects/marble-arch-tambaram-chennai-thank-you" />
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [{
    ...
    "@type": "ListItem",
    "position": 2,
    "name": "VGN Marble Arch",
    "item": "{{ url()->full() }}/projects/marble-arch-tambaram-chennai-thank-you"  
  }]
}
</script>
    ...
    @include('fragments.header')
      ...
      <div class="header-bottom project-bottom-header">
        <div class="owl-carousel owl-theme owl-carousel-banner">
          <div class="item">
            <img src="/asset/img/marble/banner/marble-banner.jpg" class="img-fluid d-lg-block d-md-block d-sm-none d-none" width="100%" alt="VGN Marble Arch Tambaram - Building/Apartments">
            <img src="/asset/img/marble/banner/mobile-marble.jpg" class="img-fluid d-lg-none d-md-none d-sm-block d-block" alt="VGN Marble Arch Tambaram - Building/Apartments" width="100%">
          </div>
         <!--  <div class="item">
            <img src="/asset/img/banners/project-banner.jpg" class="img-fluid" width="100%" alt="banner">
          </div> -->
          </div>
         <div class="project-right-box extra-height-projects">
          <div class="project-fairmont-wrap">
            <div class="fairmont-logo d-lg-block d-md-block d-sm-none d-none">
              <img src="/asset/img/marble/logo/marble-logo.webp" class="img-fluid">
              <div class="projects-heading-location">
                <h2><i class="fa fa-map-marker" aria-hidden="true"></i> Near Chromepet</h2>
                <h3>₹1.23 Crore <span>Onwards* </span></h3>
              </div>
            </div>
          </div>
          ...
          <div class="project-inner-details-top">
           <div class="project-inner-top-wrap thankyou-heading">
          <h2>Thank you</h2>
            <p>Thank you for showing interest in VGN Marble Arch, one of our Sales Representatives will contact you shortly. </p>
          </div>
            <div class="project-inner-banner-top-buttons">
              <div class="row">
             
             <div class="col-md-6">
                  <div class="project-inner-download">
                    <a href="/asset/brochure/marble/VGN-Marble-Arch-Brochure-1.pdf" download>E-Brochure <i class="fa fa-download" aria-hidden="true"></i></a>
                  </div>
                </div>
         ...
         <!--  <div class="col-4 p-0">
          ...
          <div class="col-6 p-0">
            <div class="footer-inner-icons">
              <a href="#" id="element_id" class="btn"><img src="/asset/img/icons/top-page.webp"> Top </a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-body mx-auto w-100">
          <div class="">
            <div id="popupmainform" class="form_box">
              <form  id="popupsubmitForm" method="post" action="/brixton/Residential-Property-Tambaram" class="full-form-container main-form" >
                @csrf
                <div>
