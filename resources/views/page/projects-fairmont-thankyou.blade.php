...
<head>
  <meta charset="utf-8">
  <title>Luxury Flats For Sale In Chennai - Guindy | VGN Fairmont</title>
  

<meta name="description" content="Ready to Move in Apartment Community at Just 500 Metres from Ekkatuthangal Metro, offering 2BHK/3BHK/4BHK & Duplex Flats For Sale In Chennai with World Class Amenities">
...
<meta property="og:title" content="Luxury Flats For Sale In Chennai - Guindy | VGN Fairmont" />
<meta property="og:description" content="Ready to Move in Apartment Community at Just 500 Metres from Ekkatuthangal Metro, offering 2BHK/3BHK/4BHK & Duplex Flats For Sale In Chennai with World Class Amenities" />
<meta property="og:url" content="{{ url()->full() }}/projects/fairmont-guindy-chennai-thank-you" />
<meta property="og:image" content="{{ url()->full() }}/asset/img/logo.webp" />
<meta property="og:site_name" content="VGN" />
  
  <link rel="canonical" href="{{ url()->full() }}/projects/fairmont-guindy-chennai-thank-you" />
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [{
    ...
    "position": 2,
    "name": "VGN Fairmont",
    "item": "{{ url()->full() }}/projects/fairmont-guindy-chennai-thank-you"  
  }]
}
</script>
    ...
    @include('fragments.header')
      ...
      <div class="header-bottom project-bottom-header">
        <div class="owl-carousel owl-theme owl-carousel-banner">
          <div class="item">
            <img src="/asset/img/banners/project-banner.jpg" class="img-fluid d-lg-block d-md-block d-sm-none d-none" width="100%" alt="VGN Fairmont - Luxury Apartments in Chennai">
            <img src="/asset/img/banners/mobile-fairmont.jpg" class="img-fluid d-lg-none d-md-none d-sm-block d-block" alt="banner" width="100%">
          </div>
         <!--  <div class="item">
            <img src="/asset/img/banners/project-banner.webp" class="img-fluid" width="100%" alt="banner">
          </div> -->
          </div>
         <div class="project-right-box extra-height-projects">
          <div class="project-fairmont-wrap">
            <div class="fairmont-logo d-lg-block d-md-block d-sm-none d-none">
              <img src="/asset/img/icons/fairmont-logo.webp" class="img-fluid">
              <div class="projects-heading-location">
                 <h2 style="font-size: 17px;">Homes Just 500 Metres from Ekkattuthangal Metro station</h2>
                <h3>₹3.10 Crore <span>Onwards* </span></h3>
              </div>
            </div>
          </div>
          ...
          <h2>Thank you</h2>
            <p>Thank you for showing interest in VGN Fairmont, one of our Sales Representatives will contact you shortly. </p>
          </div>
            <div class="project-inner-banner-top-buttons">
              ...
              <div class="col-md-6">
                  <div class="project-inner-download">
                    <a href="/asset/brochure/fairmont/fairmont-brochure.pdf" download>E-Brochure <i class="fa fa-download" aria-hidden="true"></i></a>
                  </div>
                </div>
