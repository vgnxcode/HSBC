...
<head>
  <meta charset="utf-8">
  <title>Top Real Estate Residential & Commercial Builder & Developer in Chennai - VGN</title>

<meta name="description" content="VGN, a leading real estate builder and developer in Chennai, offers luxurious and premium residential flats/Apartments at the best price. Contact us or visit us for high-end residential and commercial properties.">
...
<link rel="canonical" href="{{ url()->full() }}/thankyou" />
    ...
    @include('fragments.header')
      ...
      <div class="header-bottom project-bottom-header">
        <div class="owl-carousel owl-theme owl-carousel-banner">
          <div class="item">
            <img src="/asset/img/thankyou/banner1.webp" class="img-fluid d-lg-block d-md-block d-sm-none d-none" width="100%" alt="banner">
            <img src="/asset/img/thankyou/mobile-banner.webp" class="img-fluid d-lg-none d-md-none d-sm-block d-block" alt="banner" width="100%">
          </div>
         <!--  <div class="item">
            <img src="/asset/img/banners/project-banner.webp" class="img-fluid" width="100%" alt="banner">
          </div> -->
          </div>
         <div class="project-right-box extra-height">
          <div class="project-fairmont-wrap">
            <div class="fairmont-logo d-lg-block d-md-block d-sm-none d-none">
              <img src="/asset/img/logo.webp" class="img-fluid">
              <div class="projects-heading-location">
                <!-- <h2><i class="fa fa-map-marker" aria-hidden="true"></i> Tambaram</h2>
                <h3>₹73.1 Lac <span>Onwards* </span></h3> -->
              </div>
            </div>
          </div>
          <div class="projects-heading-location price-heading d-lg-none d-md-none d-sm-block d-block">
            <h3>₹25.8 Lac <span>Onwards* </span></h3>
          </div>
          <div class="project-inner-details-top">
           <div class="project-inner-top-wrap thankyou-heading">
          <h2>Thank you</h2>
            <p>Thank you for showing interest in VGN Projects one of our Sales Representatives will contact you shortly. </p>
          </div>
            <div class="project-inner-banner-top-buttons">
              <div class="row">
                <div class="col-md-12">
                  <!-- <div class="project-inner-download">
                    <a href="/asset/brochure/marble/VGN-Marble-Arch-Brochure-1.pdf" download>Download Brochure <i class="fa fa-download" aria-hidden="true"></i></a>
                  </div> -->
                </div>
                <!-- <div class="col-md-6">
                  <div class="project-inner-download">
