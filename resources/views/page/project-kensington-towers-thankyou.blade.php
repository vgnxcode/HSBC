...
<head>
  <meta charset="utf-8">
  <title>Ultra 2 & 3 BHK Luxury Homes at Guindy - Kensington Towers | VGN</title>

  <meta name="description" content="VGN Kensington Towers, which are the exclusive Signature Towers offering 14 floors of bigger and more luxurious 2 and 3 BHK homes in Guindy, Chennai.">
...
<meta property="og:title" content="Ultra 2 & 3 BHK Luxury Homes at Guindy - Kensington Towers | VGN" />
<meta property="og:description" content="VGN Kensington Towers, which are the exclusive Signature Towers offering 14 floors of bigger and more luxurious 2 and 3 BHK homes in Guindy, Chennai." />
<meta property="og:url" content="{{ url()->full() }}/projects/kensington-towers-guindy-chennai-thank-you" />
<meta property="og:image" content="{{ url()->full() }}/asset/img/logo.webp" />
<meta property="og:site_name" content="VGN" />



 <link rel="canonical" href="{{ url()->full() }}/projects/kensington-towers-guindy-chennai-thank-you" />
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [{
    ...
    "item": "{{ url()->full() }}/projects/kensington-towers-guindy-chennai-thank-you"  
  }]
}
</script>
    ...
    @include('fragments.header')
      ...
      <div class="header-bottom project-bottom-header">
        <!-- <div class="owl-carousel owl-theme owl-carousel-banner"> -->
          <div class="item">
            <img src="/asset/img/kensington-towers/banner/bannerNew2.webp?v=12" class="img-fluid d-lg-block d-md-block d-sm-none d-none" width="100%" alt="VGN Kensington Tower - Ultra Luxury Homes">
            <img src="/asset/img/kensington-towers/banner/mob-bannerNew2.webp?v=12" class="img-fluid d-lg-none d-md-none d-sm-block d-block" alt="banner" width="100%">
          </div>
         <!--  <div class="item">
         ...
         <div class="project-right-box extra-height-projects">
          <div class="project-fairmont-wrap">
            <div class="fairmont-logo d-lg-block d-md-block d-sm-none d-none">
              <img src="/asset/img/kensington-towers/logo.webp" class="img-fluid">
              <div class="projects-heading-location">
 <h2 style="font-size: 17px;">Ultra Luxury Intelligent Homes in Guindy</h2>
          ...
          <h2>Thank you</h2>
            <p>Thank you for showing interest in VGN Kensington Towers, one of our Sales Representatives will contact you shortly. </p>
          </div>
            <div class="project-inner-banner-top-buttons" style="padding-top: 18px;">
              ...
              <div class="col-md-6">
                  <div class="project-inner-download">
                    <a href="/asset/brochure/kensington-towers/Kensington Towers E-Brochure-2025.pdf" download>E-Brochure <i class="fa fa-download" aria-hidden="true"></i></a>
                  </div>
                </div>
