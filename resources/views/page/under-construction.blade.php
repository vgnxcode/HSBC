...
<head>
  <meta charset="utf-8">
  <title>Under Construction - VGN</title>
...
<body>
  <header>
    ...
    <div class="holder" style="margin: 82px;">
     ...
     <div class="" id="">
        <div class="container">
          <div class="no-file-exist text-center">
            {{-- <h1>404!</h1>
            <h2>Page not found</h2>
            <p>The page you are looking for does not exist.</p> --}}
            <img class="mb-3 w-100" src="/asset/img/under-construction.webp" alt="Under Construction">
            <br>
