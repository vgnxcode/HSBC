...
@if(View::exists('title.'.$list->id.'_gf'.'_title'))
    ...
    @else
{{ $list->Project_name }} Linkedin Landing Page
  @endif
...
<section style="position:relative;text-align:center;">
    ...
    <div class="col-md-3 hide-on-med-and-down" style="position:absolute; top:10%; right:4%;">
                <div class="card s12">
...
<div id="routemap" class="padtop20">
    <div class="container single-post-content">
        <div class="col-md-6 single-post-page">
            ...
            <div class="card-action center-align">
              <a data-lightbox="image-2" data-title="Route Map" href="{{ config('app.AWS_URL')}}/images/routemap/{{$list->id}}.jpg"><p>Click to View</p></a>
            </div>
          </div>
...
@section('scripts')
    ...
    <script src="{{ config('app.AWS_URL')}}/assets/js/main.js"></script>
     @if(View::exists('pixelcodes.linkedin.'.$list->id.'_landingpage'))
      @include('pixelcodes.linkedin.'.$list->id.'_landingpage')
    @endif
