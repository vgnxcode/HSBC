    ...
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-bank margin-r-5"></i> My Bank Details </h3><span class="pull-right" ><a href="{{ url('/customerzone/editbankdetails') }}" class="btn btn-danger btn-xs"><i class="fa fa-edit margin-r-5"></i>Edit</a></span>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
         ...
         @endif
              ...
              <h4 class="text-red"><i class="fa fa-info-circle margin-r-5"></i> Account Information</h4>
               ...
               <ul>
               <li> Bank Account No  - {{ $customer->act_no }} </li>
               <li> Bank Name  - {{ $customer->bank_name }} </li>
               <li> IFSC Code  - {{ $customer->ifsc_code }} </li>
               <li> Branch Name  - {{ $customer->branch_name }} </li>
              </ul>
