...
@section('title')
VGN Projects Estates Pvt Ltd |Customer Zone| Interior Design Survey
@endsection
    ...
    <div style="border-bottom: 1px solid #eee; background: #F44336;">
         <img src="{{ config('app.AWS_URL')}}/images/custom/vgn-logo.png" style="padding: 10px;width: 250px;background:#fff;" />
                            ...
                            <div class="card-content">
                                ...
                                <p class="para">
                                    Greetings from VGN! Are you interested in VGN doing your apartment interiors?
                                </p>
                            </div>
                            ...
                            <div style="padding:5px;" class="card-read-more">
                              <button id="interested" type="button" class="btn btn-sm btn-danger"><i class="fa fa-thumbs-up"></i> Yes I'm Interested</button>
                              <button id="notinterested" type="button" class="btn btn-sm btn-danger"><i class="fa fa-thumbs-down"></i> No I'm Not Interested</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
        ...
        $(document).ready(function(){
                       ...
                       $("#interested").on('click', function(){
                          $(".card-read-more").hide();
                          $.post("/ids/{{$saleorderno}}", {'_token': "{{csrf_token()}}",'interested': true}, function(data){
                            console.log(data);
                            if (data == '1') {
