...
@section('title')
VGN Projects Estates Pvt Ltd |Customer Zone| MyDetails Change Photo
@endsection
    ...
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-camera margin-r-5"></i> Edit Photo </h3><span class="pull-right" ><a href="{{ url('/customerzone/dashboard') }}" class="btn btn-danger btn-xs"><i class="fa fa-backward margin-r-5"></i>Dashboard</a></span>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
               ...
               <div class="col-sm-6 col-sm-offset-3">
                ...
                <form id="changedetailsForm" method="POST" action="{{ url('/customerzone/editphoto') }}" class="form-horizontal" enctype="multipart/form-data" >
                {{ csrf_field() }}
