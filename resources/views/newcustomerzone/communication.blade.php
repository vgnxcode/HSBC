...
@section('title')
VGN Projects Estates Pvt Ltd |Customer Zone| Communications Page
@endsection
                       ...
                       <a href="<?php echo $mailarray['pages'][$i]['link'] ?>" class="btn btn-danger"><?php echo $i+1; ?></a>
                           ...
                           <?php
                             ...
                             else
                             {
                              ...
                              echo '<script>window.location.href="/customerzone/communication";</script>';
                             }
                           }
                       }else
                       {
                           ...
                           window.location.href="/customerzone/dashboard";</script>';
                       }
                       ?>
