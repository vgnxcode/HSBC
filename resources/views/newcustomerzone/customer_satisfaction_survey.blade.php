    ...
    <div class="col-md-12" >
      ...
      <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-line-chart margin-r-5"></i> VGN Projects Estates Customer Satisfaction Survey </h3>
            ...
            <div class="box-body">
              <form name="myform" id="myform">
                   <div class="row" style="text-align:center;">
                     ...
                     <div class="alert text-justify" style="background-color: #dd4b39;color: #fff;">
         <h4 style="font-weight: normal;"><span style="line-height: 2.2em;">Dear {{ $customer->name }},</span><br> Greetings from VGN! With a view to enhancing customer delight and customer
  ...
  inputValidator: function (value) {
    return new Promise(function (resolve, reject) {
      if (value !== '') {
        ...
        $.post("/customerzone/customer_satisfaction_survey", {_token:'{{csrf_token()}}',customerid: customerid,selectedval:valselected,reason: value}, function(data){
                                if (data == 1) {
      ...
      html: 'Thanks for your valuble feedback!'
        ...
        $(document).ready(function(){
                        ...
                        $('#sub_click').on('click', function() {
                            ...
                            $.post("/customerzone/customer_satisfaction_survey", {_token:'{{csrf_token()}}',customerid: customerid,selectedval:selectedval,reason: ''}, function(data){
                                if (data == 1) {
