...
@if(file_exists( public_path() . '/images/banner/' . $list->id . '.jpg'))
    ...
    <div class="layerimage hide-on-small-only" style="background: url({{ asset('/images/banner/')}}/{{$list->id}}.jpg) no-repeat scroll center center / cover;height: 450px;">
...
<div class="container" style="padding: 24px;">
        <div class="row">
          ...
          <div class="col-md-4 hide-on-small-only" style="top: 0;right: -45px;">
            ...
            <form class="col s12" action="{{ url('/extproject-otpverify/') }}/{{$vendor}}/{{$projectname_str}}" method="post" style="color:#000;">
                      {{ csrf_field() }}
				...
				@endif
                  ...
                  <div class="input-field col s10 m12">
                        <input id="otp" type="text" name="otp" class="validate" value="{{ old('otp')}}">
                    ...
                    <button type="button" onclick="window.location.href='{{ url('/extproject-display/otplogout') }}/{{$vendor}}/{{$projectname_str}}'" class="waves-effect waves-light btn red white-text">Cancel</button>
                    </div>
                    </div>
        ...
        <div class="container">
            ...
            @if(session()->has('otpdata'))
                 <div class="row">
                    ...
                    <form class="col s12" action="{{ url('/extproject-otpverify/') }}/{{$vendor}}/{{$projectname_str}}" method="post">
                      {{ csrf_field() }}
                       @if(session()->has('error_msg'))
				...
				@endif
                    ...
                    <button type="button" onclick="window.location.href='{{ url('/extproject-display/otplogout') }}/{{$vendor}}/{{$projectname_str}}'" class="waves-effect waves-light btn red white-text col s4 m6">Cancel</button>
                    </div>
                    </div>
