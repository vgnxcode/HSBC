...
{{ $list->Project_name }} Facebook Thankyou Page
...
@section('stylesheet')
    ...
    @if(View::exists('pixelcodes.facebook.'.$list->id.'_thankyou'))
      @include('pixelcodes.facebook.'.$list->id.'_thankyou')
    @endif
     <style>
   h2.styleheader {
      font-size: 32px;
...
<section style="position:relative;text-align:center;">
  ...
  <h2 class="newtitle center-align">Thanks for your Enquiry</h2> <h2 class="newtitle center-align"><br><a href="{{ url('/facebook-display/project/')}}/{{$projectname_str}}" class="btn newwhitewave waves-effect waves-light btn-medium regular-text"><i class="mdi-content-reply left"></i> Go Back</a></h2>
</section>
...
$('#bannerim').attr('src',"{{ env('AWS_URL')}}/images/banner/mobile/<?php echo $list->id; ?>.jpg");
}
else{
    $('#bannerim').attr('src',"{{ env('AWS_URL')}}/images/banner/<?php echo $list->id; ?>.jpg");
