...
@section('stylesheet')
    ...
    <link rel="stylesheet" type="text/css" href="{{ env('AWS_URL')}}/mobileflag/css/jquery.ccpicker.css">
...
@section('scripts')
    ...
    <script src="{{ env('AWS_URL')}}/mobileflag/js/jquery.ccpicker.js" type="text/javascript"></script>
    <script>
