...
<div class="row bread">
  ...
  <li><a href="{{ url('/nri/project/') }}/{{$projectname_str}}">VGN {{$list->Project_name}}</a></li>
  <li>Thank You</li>
</ul>
</div>
        </div>
...
@endif
  ...
  <h2 class="newtitle center-align">Thanks for your Enquiry</h2> <h2 class="newtitle center-align"><br><a href="{{ url('/nri/project/')}}/{{$projectname_str}}" class="btn newwhitewave waves-effect waves-light btn-medium regular-text"><i class="mdi-content-reply left"></i> Go Back</a></h2>
</section>
