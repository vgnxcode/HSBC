...
<div class="container" style="padding: 24px;">
    ...
    font-weight: 400;">For more information, Kindly Fill in</span>
            <form class="col s12" action="{{ url('/nri/project/') }}/{{$projectname_str}}" method="post" style="color:#000;">
                      {{ csrf_field() }}
                    <div class="row">
    ...
    <div class="row hide-on-med-and-up">
        <div class="container">
                 ...
                 <div class="row">
                    ...
                    <form class="col s12" action="{{ url('/nri/project/') }}/{{$projectname_str}}" method="post">
                      {{ csrf_field() }}
                    <div class="row">
...
@endif
      ...
      <div class="col-md-6 col-sm-12 ">
        @if($latitude != 0)
          ...
          <a href="{{url('/googlemap')}}/{{$projectname_str}}" class="maplink" style="font-size: 18px;"><i class="fa fa-map-marker fa-2x"></i> Click Here to get Live Direction</a>
        </div>
        @endif
