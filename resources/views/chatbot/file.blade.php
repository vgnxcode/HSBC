...
<div class="row">
    <div class="col-md-12  pull-right chatbot_card">
      <div class="card" style="/*margin-right:3px;*/ z-index:3;">
        ...
        <h3><img class="responsive-img" src="{{ config('app.AWS_URL')}}/images/vgnchatbot/robot-icon-circle2.png" alt="chatbot circle" width="30" style="margin-top: -1px;"> VGN 24/7 Chat Support <i class="fa fa-times-circle pull-right chat_header_close chat_close"></i><i class="fa fa-refresh pull-right chat_header_close refresh_page"></i></h3>
        </div>
...
<option value="+263">Zimbabwe +263</option>
  ...
  <div id="chatIcon">
        <div class="chatImage" id="chtbtn" style="display: block; cursor: pointer;">
            <img src="{{ config('app.AWS_URL')}}/images/vgnchatbot/robot-icon-circle2.png" alt="chatIcon" />
        </div>
    </div>
